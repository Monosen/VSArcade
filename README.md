...
<img src="media/icon.png" alt="VSArcade Logo" width="128" height="128" />

# VSArcade

**Retro arcade games inside VS Code** — Game Boy-inspired visuals, shared webview runtime, zero context switching.

[![VS Code Marketplace](https://img.shields.io/badge/VS%20Code-Extension-blue?logo=visualstudiocode&logoColor=white)](https://github.com/Monosen/VSArcade)
...
Press `F5` to open an Extension Development Host and test locally.
