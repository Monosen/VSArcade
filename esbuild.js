...
async function main() {
  ...
  const webviewCtx = await esbuild.context({
    ...
    entryPoints: {
      ...
      "games/minehunt": "src/games/minehunt/webview.ts",
      "games/pong": "src/games/pong/webview.ts",
      "games/brickout": "src/games/brickout/webview.ts",
      "games/skyhop": "src/games/skyhop/webview.ts",
      "games/dotchase": "src/games/dotchase/webview.ts",
      "games/invaders": "src/games/invaders/webview.ts",
      "games/duel": "src/games/duel/webview.ts",
    },
    format: "iife",
    outdir: "./out",
    platform: "browser",
